...
stdenv.mkDerivation rec {
  ...
  src =  if stdenv.hostPlatform.system == "x86_64-linux" then fetchzip {
    ...
    extension = "zip";
    sha256 = "sha256-InED+kWmCYf3FBk1AX1OwpOoOnDnHh7OREBirLle2UU=";#"sha256-3k31i6rg798ztMifvBhSiwBVod95z/RlaNh8zMU5bO8=";2.5.4-beta3 "sha256-BtP/lA9EU2H3DvjYny/6842+3nefjZFEz7GP2y+0iJM="; 2.5.4-beta1
    ...
    url = "https://icesl.loria.fr/assets/other/download.php?build=${version}&${_versionType}&os=amd64";
    extension = "zip";
    sha256 = "sha256-InED+kWmCYf3FBk1AX1OwpOoOnDnHh7OREBirLle2UU=";#"sha256-3k31i6rg798ztMifvBhSiwBVod95z/RlaNh8zMU5bO8=";2.5.4-beta3
